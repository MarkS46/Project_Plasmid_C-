...
//*** model parameters *********
    ...
    const double K0 = 4.0; // half saturation constant of plasmid free for resource
    const double K1 = 4.0; // half saturation constant of plasmid bearing for resource
    ...
    const double Ain = 0; // input resource concentration of antibiotic
